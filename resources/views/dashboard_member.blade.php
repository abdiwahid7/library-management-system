    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg p-6">
                ...
                <a href="{{ route('books.member') }}" class="inline-block px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition duration-300">
                    View Books
                </a>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg p-6 md:col-span-2">
                <h3 class="text-xl font-semibold mb-4 text-green-600">Your Transactions</h3>
